...
VALUES
('Malcolm', 'Reynolds', 'mal', '$2a$12$KAm8uX7m7Bk8BWFgSVZDLuv2v/rHBn/o9Enshrp/8fM6Cbl0KQu26', '$2a$12$n/.T/tytu2uEQV587gBhIeTe3v2YrJrgE9J/JRAxfUDIiuvOrqkk.', FALSE, now() - INTERVAL '1 day', now()), --Browncoats!1, +17894561234
('Hoban', 'Washburne', 'wash', '$2a$12$v80Lr22dHqqO0ZRwBcXCl.B0H9FuvKssojDa2pEVwzgWEnKOI9O7y', '$2a$12$FjVnFZf1bOFei07.w0TmuO85ORpJXJVvyBoONk9FRORSn.avFyzoW', TRUE, now() - INTERVAL '2 day', now() - INTERVAL '1 day'), --#Pilot007, +15551234567
...
('Jayne', 'Cobb', 'hero', '$2a$12$we0xScJ4Z0OMpfchDzwhke.auV5rKk.0UeHkqOzzjmiYNvoLkYgKu', '$2a$12$rqui.zjPmRKQCnrRBlRZ1u1aQ3hXjeS5KJg/kiDnOfShADmmOq336', TRUE, now(), now()), --OfCanton!, +11234567890
('River', 'Tamm', 'rtamm', '$2a$12$4LoHPh/OXpcQxq9HWWiNreDj9CdpmD2X.1qHu7cdviZsZRM/w8Xt.', '$2a$12$Tbvd1h7TGdtgb2OsKAN7cOCQJvDNOBanz9aDASzx5y1xFuTpnkuua', FALSE, now(), now()) --Vo1c35, +11234567890
;
